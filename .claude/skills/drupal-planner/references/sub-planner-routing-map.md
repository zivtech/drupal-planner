...
5. `/drupal-planner` — Tie it together with permissions, cache, migrations
...
### Theme Rebuild
1. `/drupal-planner.theme` — Design theme architecture
2. `/drupal-planner` — Plan any module-level changes needed for theme (render arrays, preprocess)
